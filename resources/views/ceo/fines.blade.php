					...
					<tr>
						<form class="change-fines" method="POST" action="">
							...
							<td class="col-3">
								...
								<input type="number" class="inp-fines-time d-none" name="fines"
								       value="{{ $each->fines }}">
							</td>
							<td class="col-3">
								...
								<input type="text" class="inp-deduction d-none" name="deduction"
							...
							<td class="col-2">
								<div align="center">
									<i type="button"
									   class="btn-change-fines fa-solid fa-pen btn-edit-role text-warning"></i>
