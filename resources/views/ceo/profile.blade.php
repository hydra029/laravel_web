                        ...
                        <tr>
                            <td class="col-6">
                                ...
                                <span class="error-message-fname text-danger"> </span><input type="text"
                                    name="fname" class="form-control inp-fname" placeholder="First Name" value="{{$data->fname}} "required>
                            </td>
                            <td>
                                Last Name:
                                <br>
                                <span class="error-message-lname text-danger"> </span><input type="text"
                                    name="lname" class="form-control inp-lname " placeholder="Last Name" value="{{$data->lname}}" required>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td colspan="2">
                                ...
                                <span class="error-message-dob text-danger"> </span> <input type="date"
                                    ...
                                    style="width: 100%; display: inline;" required value="{{$data->date_of_birth}}"
                        ...
                        <tr>
                            <td colspan="2">
                                ...
                                <span class="error-message-phone text-danger"> </span> <input type="number"
                                    name="phone"  placeholder="Number phone"
                                    class="form-control inp-phone" value="{{ $data->phone }}" required>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
                                ...
                                <span class="error-message-email text-danger"> </span><input type="email"
                                    ...
                                    class="form-control inp-email"   required>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
