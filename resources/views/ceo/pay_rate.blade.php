        ...
        $(document).ready(function () {
            ...
            function show(dept_id) {
                        ...
                        success: function (response) {
                            pay_rate.html('');
                            pay_rate.append('<table class="table table-striped table-centered table-sm table-bordered  student-table-index">' +
                            ...
                            $.each(response, function (index, value) {
                                pay_rate.append('<tr>' +
                                    ...
                                    '<input type="text" name="role_id" class="form-control " value="' + value.role_id + '">' +
                                    '</label>' +
                                    '</td>' +
                                    '<td class="col-1">' +
