        ...
        $(document).ready(function () {
            ...
            $(".fc-prevYear-button")
                .before($('<button>')
                    ...
                    .addClass('btn btn-success d-none')
                    .text('Confirm')
                )
                .before($('<button>')
                    .attr({
                    ...
                    .done(function (response) {
                        ...
                        for (let i = 0; i < emp_num; i++) {
                            ...
                            for (let j = 0; j < length; j++) {
                                ...
                                num--;
                                let emp_role = response[i]['attendance'][j]['emp_role'];
                                ...
                                if (emp_id !== response[i]['attendance'][j]['emp_id']) {
                                    emp_id = response[i]['attendance'][j]['emp_id'];
                                    e_num++;
                                    if (e_num % 2 === 0) {
                                        text_color = '#000000';
                        ...
                        $(".emp-name").click(function () {
                            ...
                            $('#sl-1, #sl-2, #sl-3, .fc-button').addClass('d-none');
                            $('#back,#confirm , #emp_detail').removeClass('d-none');
                            calendar.removeAllEvents();
                            del();
            ...
            back.click(function () {
                ...
                $('#back, #confirm, #emp_detail, .fc-goto-button').addClass('d-none');
                emp();
                loadAttendance(today);
            })
